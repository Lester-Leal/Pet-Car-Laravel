<?php $__env->startSection('title', 'Outcome indicator'); ?>
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                          ...
                          <br>
                          <hr>
                           <?php echo $__env->make('indicators.outcome.create', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                        </div>
                        <!-- /.card-header -->
                        <div class="card-body">
                            <?php
                                $page = "indicatorOutcome";
                            ?>
                            ...
                            <tbody>
                                <?php $__currentLoopData = $outcomes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $outcome): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    <tr>
                                     ...
                                     <?php echo $__env->make('indicators.outcome.update', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php echo $__env->make('layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Developer\Desktop\laravel Projects\manaso\resources\views/indicators/outcome/index.blade.php ENDPATH**/ ?>