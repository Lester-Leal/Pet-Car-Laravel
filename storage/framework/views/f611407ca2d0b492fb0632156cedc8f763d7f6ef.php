                ...
                <div class="col-md-8">
                    <div class="card">
                        <div class="card-header">
                            ...
                            <?php echo $__env->make('projects.clm.activity.create', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                        </div>
                        ...
                        <div class="card-body">
                            ...
                            <ul class="list-group">
                                ...
                                <?php $__currentLoopData = $event->issues; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $issue): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <ul class="list-group mt-4">
                                ...
                                <?php $__currentLoopData = $event->concerns; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $concern): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <li class="list-group-item">
                ...
                <div class="col-md-4">
                    <div class="card">
                        <div class="card-header">
                          ...
                          <a href="" class="btn btn-primary float-right" data-target="#participants" data-toggle="modal">
                              <i class="fas fa-plus-circle"></i>
                                Add participants
                          </a>
                          <?php echo $__env->make('projects.clm.activity.participants', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                        </div>
                        <!-- /.card-header -->
                        <div class="card-body">
                            <form method="POST" action="<?php echo e(route('project.clm.monitoring.update', $event->id)); ?>">
                                <?php echo csrf_field(); ?>
...
<script>
    $('body').on('change','#status', function () {
        if ($(this).val()==1) {
            ...
            $("#concern").attr("required", "true");
        }else{
            $('#activity').slideUp();
            $("#item").removeAttr("required");
            $("#concern").removeAttr("required");
...
<?php echo $__env->make('layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Developer\Desktop\laravel Projects\manaso\resources\views/projects/clm/activity/index.blade.php ENDPATH**/ ?>