                            ...
                            <tbody>
                                <?php $__currentLoopData = $eventtypes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $eventtype): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    <tr  data-toggle="collapse" href="#top<?php echo e($id); ?>">
                                        ...
                                        <td>
                                            <?php echo e($eventtype->objective->name); ?>
...
<?php echo $__env->make('layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Developer\Desktop\laravel Projects\manaso\resources\views/eventtypes/index.blade.php ENDPATH**/ ?>