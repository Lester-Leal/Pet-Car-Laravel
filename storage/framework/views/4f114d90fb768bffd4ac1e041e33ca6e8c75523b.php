<?php $__env->startSection('title', 'Output Indicator'); ?>
                    ...
                    <div class="card">
                        <div class="card-header">
                          <a href="#" class="btn btn-primary float-right" data-toggle="modal" data-target="#add">
                           ...
                           <?php echo $__env->make('indicators.output.create', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>

                        </div>
                        <!-- /.card-header -->
                        <div class="card-body">
                            <?php
                                $page = "indicatorOutput";
                            ?>
                            ...
                            <tbody>
                                <?php $__currentLoopData = $outputs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $output): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <?php echo e($output->outputs->output); ?>

                                        </td>

                                        <td>
                                            <?php echo e($output->indicator); ?>

                                        </td>
                                        <td>
                                            <?php echo e($output->baseline); ?>

                                        </td>
                                        <td>
                                            <?php echo e($output->period); ?>

                                        </td>
                                        <td>
                                            <?php if($output->period=="Annually"): ?>
                                            <?php $__currentLoopData = $output->detail; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $detail): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <?php echo e($detail->target); ?>

                                             <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            <?php else: ?>
                                                <?php echo e($output->detail->sum('target')); ?>
                                     ...
                                     <?php echo $__env->make('indicators.output.update', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php echo $__env->make('layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Developer\Desktop\laravel Projects\manaso\resources\views/indicators/output/index.blade.php ENDPATH**/ ?>