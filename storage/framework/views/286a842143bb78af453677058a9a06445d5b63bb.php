                ...
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="card-body" id="printableArea">
                            <div class="row">
                                <div class="col-md-6">
                                    <img src="<?php echo e(asset('assets/images/logo.png')); ?>" width="100" height="140">
                                </div>
...
<?php echo $__env->make('layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\mphat\Desktop\LARAVEL PROJECTS\pet_care\resources\views/admin/transactions/receipt.blade.php ENDPATH**/ ?>