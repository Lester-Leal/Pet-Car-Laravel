    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <form method="POST" action="<?php echo e(route('indicators.outcomes')); ?>">
                <?php echo csrf_field(); ?>
                <input type="hidden" name="indicator_type" value="outcome">
            <div class="modal-body">
                <div class="container-fluid">
                  ...
                  <div class="form-group">
                    ...
                    <input type="number" name="frequency" id="frequency" class="form-control" placeholder="" aria-describedby="helpId" min="1" required>
...
<?php /**PATH C:\Users\Developer\Desktop\laravel Projects\manaso\resources\views/indicators/outcome/create.blade.php ENDPATH**/ ?>