        ...
        <div class="modal-content">
                <div class="modal-header">
                    ...
                    <form method="POST" action="<?php echo e(route('indicators.outcomes')); ?>">
                        <?php echo csrf_field(); ?>
                        <input type="hidden" name="indicator_type" value="intermediate">
            <div class="modal-body">
                <div class="container-fluid">
                  ...
                  <div class="form-group">
                    ...
                    <select class="form-control mt-2" name="intermediateoutcome_id" id="intermediateoutcome_id" required>
                        <option value="">Select one</option>
                    </select>
                  </div>
...
<?php /**PATH C:\Users\Developer\Desktop\laravel Projects\manaso\resources\views/indicators/intermediate/create.blade.php ENDPATH**/ ?>