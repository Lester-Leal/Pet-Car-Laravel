                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                          <a href="<?php echo e(route('active.projects', 'CLM')); ?>" class="btn btn-danger float-left" >
                              <i class="fas fa-arrow-circle-left"></i>
                                Back
                          </a>

                          <a href="<?php echo e(route('createClm', $event->id)); ?>" class="btn btn-primary float-right" >
...
<?php echo $__env->make('layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Developer\Desktop\laravel Projects\manaso\resources\views/projects/clm/record.blade.php ENDPATH**/ ?>