...
<?php $__env->startSection('body'); ?>
    <section class="content-header">
        ...
        <div class="row mb-2">
            <div class="col-sm-6">
            <h1>
                Community Led Monitoring Reporting
            </h1>
            </div>
                ...
                <div class="col-md-8">
                    <div class="card">
                        <div class="card-header">
                            ...
                            <?php echo $__env->make('projects.clm.report.create', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                        </div>

                        <div class="card-body">
                            <?php if($event->issues->count()>0): ?>
                            <ul class="list-group">
...
<?php echo $__env->make('layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Developer\Desktop\laravel Projects\manaso\resources\views/projects/clm/report/reporting.blade.php ENDPATH**/ ?>