                            ...
                            <tbody>
                                <?php $__currentLoopData = $eventplans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $eventplan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    <tr  data-toggle="collapse" href="#top<?php echo e($id); ?>">
                                        ...
                                        <td>
                                            <?php echo e($eventplan->facility->name); ?>
                                        ...
                                        <td>
                                            ...
                                            <a href="<?php echo e(route('project.clm.activity', $eventplan->id)); ?>" class="btn btn-warning btn-sm">
                                                <i class="fa fa-plus-circle"></i>
                                                Record data
                                            </a>
                                            <?php else: ?>
                                            <a href="<?php echo e(route('project.clm.monitoring', $eventplan->id)); ?>" class="btn btn-warning btn-sm">
                                                <i class="fa fa-plus-circle"></i>
                                                Record data
                                            </a>
                                            <?php endif; ?>
...
<?php echo $__env->make('layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Developer\Desktop\laravel Projects\manaso\resources\views/projects/clm/index.blade.php ENDPATH**/ ?>