...
<head>
    ...
    <link rel="shortcut icon" href="<?php echo e(asset('assets/images/logo2.png')); ?>">
    <!-- Font Awesome -->
                ...
                <a href="#" class="h1">
                    <strong>
                        <span class="text-primary">
                            VET<span class="text-danger">ERI</span>NARY
                        </span>
                    </strong>
                </a>
            </div>
            <div class="card-body">
                <div class="row">
                    <div class="col-md-12 text-center">
                        <img src="<?php echo e(asset('assets/images/logo2.png')); ?>" alt="" width="140" height="140">
                    </div>
                </div>
...
<?php /**PATH C:\xampp\htdocs\pet_care\resources\views/login.blade.php ENDPATH**/ ?>