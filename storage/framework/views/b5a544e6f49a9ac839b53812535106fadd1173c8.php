...
<div class="modal fade" id="track<?php echo e($id); ?>" tabindex="-1" role="dialog" aria-labelledby="modelTitleId" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form method="POST" action="<?php echo e(route('projects.tracking.activity', $activity->project_id)); ?>">
                <?php echo csrf_field(); ?>
...
<?php /**PATH C:\Users\Developer\Desktop\laravel Projects\manaso\resources\views/tracking/activities/track.blade.php ENDPATH**/ ?>